...
## Corpus Check
- 65 files · ~34,431 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 647 nodes · 893 edges · 56 communities (51 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ae40baf4`
...
- `startPilcrow()` --calls--> `discoverRoutes()`  [EXTRACTED]
  packages/routekit/src/boot.ts → packages/routekit/src/discover.ts

## Communities (56 total, 5 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (21): InvalidatePayload, PatchPayload, startDbNotificationPipeline(), runTests(), defaultHubConfig, emitter, FsrHubConfig, FsrHubStreamOptions (+13 more)
...
Cohesion: 0.05
Nodes (39): abortMap, BLOCKED_ATOM_KEYS, buildMaps(), DEBUG, destroy(), destroyAllLive(), elementAtomSubs, FORBIDDEN_HTML_TAGS (+31 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (41): App startup (promote_after = 0 or absent), code:block1 (Redis     = serve layer + pub/sub bus (REQUIRED — hot, fast,), code:html (<!-- Static field — baked directly -->), code:toml ([cache]), code:rust (dep!(tickets, id, ticket_id)             // typed Dependency), code:block13 (Request arrives), code:block14 (Request arrives), code:block15 (pilcrow::invalidate!(dep!(tickets, id, 123))) (+33 more)
...
Cohesion: 0.09
Nodes (24): appRequire, buildActionHandler(), buildPageHandler(), injectFsrScriptTag(), React, ReactDOMServer, startPilcrow(), discoverRoutes() (+16 more)

### Community 7 - "Community 7"
Cohesion: 0.13
Nodes (27): actions, IndexPage(), appendActionName(), PilcrowReactContext, PilcrowReactContextValue, PilcrowReactProvider(), publishSilcrowAtom(), resolvePilcrowAction() (+19 more)

### Community 8 - "Community 8"
Cohesion: 0.16
Nodes (7): escapeHtml(), findSLiveContentRange(), findSLiveSlots(), injectFsrSlots(), runTests(), run(), FsrWatcher

### Community 9 - "Community 9"
Cohesion: 0.13
Nodes (21): buildFetchOptions(), bustCacheOnMutation(), cacheGet(), cacheSet(), collectLayoutPatterns(), finalizeNavigation(), getTarget(), getTimeout() (+13 more)

### Community 10 - "Community 10"
Cohesion: 0.13
Nodes (20): applyLivePatchPayload(), confirmOptimistic(), connectWsHub(), createWsHub(), disconnectLive(), dispatchWsMessage(), getOrCreateWsHub(), hasPendingMutationForTarget() (+12 more)

### Community 11 - "Community 11"
Cohesion: 0.11
Nodes (12): DependencyKey, LiveProp, LiveTarget, ActionHandler, LiveFieldMeta, LoadResult, MiddlewareConfig, PageDefinition (+4 more)

### Community 12 - "Community 12"
Cohesion: 0.11
Nodes (15): BackendConfig, CacheConfig, CacheProvider, ClientRuntimeConfig, DeepPartial, DEFAULT_CONFIG, FsrConfig, I18nConfig (+7 more)

### Community 14 - "Community 14"
Cohesion: 0.17
Nodes (16): connectSseHub(), createSseHub(), getOrCreateSseHub(), invalidate(), mergeOrRemoveItem(), normalizeSSEEndpoint(), onSSEEvent(), openLive() (+8 more)

### Community 15 - "Community 15"
Cohesion: 0.13
Nodes (13): Background, code:block1 (promote_after = 0 or absent  → SSG  (bake at startup, surgic), code:block2 (crates/core         — AppError, AppResult, PilcrowConfig), code:block3 (crates/runtime/src/fsr/          — LiveProps, DependencyKey,), code:block36 (live.rs), code:block37 (Phase 1   DB migration), code:rust (/// Implement this on any `Live` struct defined in a route's), Complete developer surface (nothing else needed) (+5 more)
...
Cohesion: 0.23
Nodes (13): bindElementToScope(), evictPrefetch(), getStableId(), initScopeBindings(), publishOptimistic(), reconcile(), resolveAtomByScope(), revertOptimistic() (+5 more)
...
Cohesion: 0.18
Nodes (12): applyFragment(), applyHeadTemplate(), extractHeadTemplate(), hardenBlankTargets(), hasSafeProtocol(), hasSafeSrcSet(), isOnHandler(), parseFragmentSlot() (+4 more)
...
Cohesion: 0.5
Nodes (4): extractHTML(), prepareSwapContent(), processToasts(), setToastHandler()
...
## Knowledge Gaps
- **241 isolated node(s):** `pilcrowFsr`, `actions`, `main`, `AppResult`, `HookError` (+236 more)
...
- **Why does `use()` connect `Community 17` to `Community 2`, `Community 7`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `useSilcrowResource()` connect `Community 7` to `Community 17`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `FSR — Field-Selective Rendering: Implementation Plan` connect `Community 1` to `Community 4`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **What connects `pilcrowFsr`, `actions`, `main` to the rest of the system?**
